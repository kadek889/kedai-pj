...
if (isset($_GET['registered']) && $_GET['registered'] == 'true') {
    $success_message = "Registrasi berhasil! Silakan login dengan username dan password yang Anda daftarkan.";
} 
    ...
    if ($result) {
        if (mysqli_num_rows($result) == 1) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                $_SESSION['photo'] = $row['photo']; // Simpan foto pengguna jika ada
